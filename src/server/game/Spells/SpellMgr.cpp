...
void SpellMgr::LoadSpellInfoStore()
{
    ...
    {
        if (SpellInfo const* SpellInfo = sSpellStore.LookupEntry(i))
            mSpellInfoMap[i] = new SpellInfo(SpellInfo);
    }
...
void SpellMgr::LoadSpellMaps()
{
    ...
    do
    {
        ...
        if (const SpellInfo* spellInfo = sSpellStore.LookupEntry(spell))
        {
        ...
        {
            SpellInfo const* spellInfo = sSpellStore.LookupEntry(abs(spellMap.auraSpell));
            if (!spellInfo)
            {
